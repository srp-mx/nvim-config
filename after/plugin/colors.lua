...
function ColorMyPencils(color)
    ...
    vim.api.nvim_set_hl(0, "@constructor", { bg = "none", fg = funcion, italic=true })
    vim.api.nvim_set_hl(0, "Conditional", { bg = "none", fg = palabrareservada })
    vim.api.nvim_set_hl(0, "@keyword.conditional", { bg = "none", fg = palabrareservada })
    vim.api.nvim_set_hl(0, "@keyword.return", { bg = "none", fg = palabrareservada })
    ...
    vim.api.nvim_set_hl(0, "@keyword.exception", { bg = "none", fg = palabrareservada })
    ...
    vim.api.nvim_set_hl(0, "@type.builtin", { bg = "none", fg = tipo })
    ...
    vim.api.nvim_set_hl(0, "@keyword.conditional.ternary", { bg = "none", fg = operador })
